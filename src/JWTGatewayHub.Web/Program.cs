...
using JWTGatewayHub.Core;
using JWTGatewayHub.Infrastructure;
...
var signkey = builder.Configuration.GetSection("SignKey").Value;
...
builder.Services.AddAuthentication("Bearer")
 ...
 {
   var signingKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(signkey!));
